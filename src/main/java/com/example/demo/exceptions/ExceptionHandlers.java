...
import com.example.demo.model.dto.ErrorResult;
import com.example.demo.model.dto.ErrorResult.Type;
...
public class ExceptionHandlers {
	...
	private final Map<Class<? extends AuthenticationException>, String> authenticationErrors 
		= Map.of(
				UsernameNotFoundException.class, "Please check your login username.",
